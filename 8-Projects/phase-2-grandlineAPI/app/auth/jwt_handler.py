...
#
# TODO: Import jwt from jose (python-jose); datetime, timedelta from datetime
...
#         2. Calculate the expiry time: now + timedelta(minutes=expire_minutes)
#         3. Add "exp" key to the copy with the expiry datetime
#         4. Encode using jwt.encode(payload, SECRET_KEY, algorithm=ALGORITHM)
