...
End-to-end ML pipeline that predicts pirate bounties from crew stats using scikit-learn and PyTorch. Covers the full workflow from data generation, classical baselines, and neural network training to evaluation and a live demo. Tools used include NumPy, Pandas, scikit-learn, XGBoost, PyTorch, Weights & Biases, and Streamlit.
